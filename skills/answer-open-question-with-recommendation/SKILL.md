...
Follow `.agents/plugins/cairn/shared/get-current-milestone.md` to resolve `<MILESTONE_DIR>`. Never
...
`.agents/plugins/cairn/shared/answer-procedure.md`, which owns the
