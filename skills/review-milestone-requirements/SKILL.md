...
```
python3 .agents/plugins/cairn/tools/open_questions.py remove <MILESTONE_DIR> "<Short Title>"
```
...
```
python3 .agents/plugins/cairn/tools/open_questions.py add <MILESTONE_DIR> "<Short Title>" <<'EOF'
<Question text here.>
EOF
```
