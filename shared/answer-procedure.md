...
tool, `python3 .agents/plugins/cairn/tools/open_questions.py <subcommand> <MILESTONE_DIR> …`, that
...
```
python3 .agents/plugins/cairn/tools/open_questions.py remove <MILESTONE_DIR> "<SHORT TITLE>" [--option "<OPTION>"]
```
...
```
python3 .agents/plugins/cairn/tools/open_questions.py remove <MILESTONE_DIR> "<MOOTED SHORT TITLE>"
```
