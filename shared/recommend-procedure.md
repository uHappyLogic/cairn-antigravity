...
`.agents/plugins/cairn/shared/alternatives-procedure.md`; this procedure takes its output as
given.
...
`python3 .agents/plugins/cairn/tools/open_questions.py <subcommand> <MILESTONE_DIR> …`, never a
