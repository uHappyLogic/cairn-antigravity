...
produces, and lives in `.agents/plugins/cairn/shared/recommend-procedure.md`; nothing here forms a
preference.
...
open-question tool, `python3 .agents/plugins/cairn/tools/open_questions.py <subcommand>
